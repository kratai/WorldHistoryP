...
public class QuizRPS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_rps);
//        chooseans = (ImageView) findViewById(R.id.chooseans);
    ...
    public void checkAnswer(View view) {
        ...
        if (btnText.equals(rightAnswer)) {
            ...
            final Intent i = new Intent(this, RockPaperScissor.class);

            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Correct!");
            builder.setPositiveButton("ืnext", new DialogInterface.OnClickListener() {
...
//                builder.setCancelable(false);
                ...
                // Wrong...
                String alertTitle = "wrong answer :(";

                final Intent i = new Intent(this, RPSsum.class);
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
