...
import com.example.admin.worldhistoryp.Adapter.GridViewAnswerAdapter;
import com.example.admin.worldhistoryp.Adapter.GridViewSuggestAdapter;
...
public class picquiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picquiz);
        //Init View
        initView();
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(result.equals(correct_answer))
                {
                    ...
                    GridViewSuggestAdapter suggestAdapter = new GridViewSuggestAdapter(suggestSource,getApplicationContext(),picquiz.this);
                ...
                {
                    Toast.makeText(picquiz.this, "Incorrect!!!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
