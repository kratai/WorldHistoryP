...
public class SliderAdapterAsia3 extends PagerAdapter {
    Context context;
    LayoutInflater layoutInflater;
    public SliderAdapterAsia3(Context context) {
        this.context = context;
    }

    public int[] slide_images = {
            R.drawable.lessasia10
    };
...
//                if (position == 0) {
//
//                    Intent it = new Intent(context.getApplicationContext(), asia10.class);
